...
export default {
  ...
  getAllDetailUsersByAgent: (params) => {
    return new Promise((resolve, reject) => {
      client.POST("users/agents/detail/users", params).then((data) => {
        resolve(data);
      });
    });
  },
  ...
  getAllAgentsDetail: (params) => {
    return new Promise((resolve, reject) => {
      client.POST("users/agents/detail", params).then((data) => {
        resolve(data);
      });
    });
  },
  ...
  create: (params) => {
    return new Promise((resolve, reject) => {
      client.POST("users/create", params).then((data) => {
        resolve(data);
      });
    });
  },
  ...
  getAllHistoryGames: (params) => {
    return new Promise((resolve, reject) => {
      client.POST("users/games/history", params).then((data) => {
        resolve(data);
      });
    });
  },
  ...
  gestPlayers: (params) => {
    return new Promise((resolve, reject) => {
      client.POST("users/best/games", params).then((data) => {
        resolve(data);
      });
    });
  },
